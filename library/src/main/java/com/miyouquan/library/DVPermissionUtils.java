 ...
 * 例如 <activity android:name="~.DVPermissionUtils$RequestPermissionsActivity" android:theme="@style/Theme.AppCompat.Light.Dialog"/>
 * PS：需要的权限需要写在AndroidManifest，然后在才代码动态申请，否则无法申请
 */
public class DVPermissionUtils {
     ...
     * @param listener 结果回调
     */
    private static void start(Context context, String[] permissions, DVPermissionUtils.OnPermissionListener listener){
